...
import { Facebook, Instagram, Twitter, Mail, Phone, MapPin, Plane, GraduationCap, Globe } from "lucide-react";
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-300">123 Rue de l'Université, 75001 Paris, France</span>
              </li>
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href="mailto:contact@bambatravelexpert.com" className="text-gray-300 hover:text-white">
                  contact@bambatravelexpert.com
                </a>
              </li>
            </ul>
          </div>
